...
<article class="card event-card reveal">
    ...
    <?php endif; ?>
    <p class="eyebrow"><?php echo church_theme_icon('calendar', ['size' => 14]); ?><?php echo esc_html(church_theme_get_event_datetime($post_id)); ?></p>
    <h2><a href="<?php echo esc_url(church_theme_get_event_url($post_id)); ?>"><?php the_title(); ?></a></h2>

    <?php if ($event_location !== '') : ?>
        <p class="event-card__meta">
            <?php echo church_theme_icon('location', ['size' => 14]); ?>
